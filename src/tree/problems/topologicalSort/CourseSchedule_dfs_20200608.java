 ...
 */
public class CourseSchedule_dfs_20200608 {

    public static void main(String args[]) {
        CourseSchedule_dfs_20200608 class1 = new CourseSchedule_dfs_20200608();
    ...
    public boolean canFinish(int numCourses, int[][] prerequisites) {
        ...
        // 2: BFS
        return dfs(graph, numCourses, prerequisites, ascii);

    }

    private boolean dfs(Map<Integer, Set<Integer>> graph, int projects, int[][] dependencies, int[] ascii) {
