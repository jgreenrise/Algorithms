...
public class a3_RobotInGrid_getTotalPaths {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Rec: " + robot.recursive(matrix, offlimits) + ", Mmeo: " + robot.recursiveWithMemo(matrix, offlimits));
    ...
    public int recursiveWithMemo(int[][] mat, boolean[][] offlimit) {
        ...
        return recursiveWithMemo(mat, offlimit, 0, 0, totalRows, totalCols, memo);
    }

    private int recursiveWithMemo(int[][] mat, boolean[][] offlimits, int currRow, int currCol, int totalRows, int totalCols, int[][] memo) {
        ...
        if (currCol + 1 < totalCols && !offlimits[currRow][currCol + 1]) {
            if (currCol + 1 == totalCols - 1 && currRow == totalRows - 1) {
                ...
                right = recursiveWithMemo(mat, offlimits, currRow, currCol + 1, totalRows, totalCols, memo);
        ...
        if (currRow + 1 < totalRows && !offlimits[currRow + 1][currCol]) {
            if (currCol == totalCols - 1 && currRow + 1 == totalRows - 1) {
                ...
                bottom = recursiveWithMemo(mat, offlimits, currRow + 1, currCol, totalRows, totalCols, memo);
    ...
    public int recursive(int[][] mat, boolean[][] offlimit) {
        int totalRows = mat.length;
        int totalCols = mat[0].length;
